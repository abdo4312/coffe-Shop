...
export function LoginPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // توجيه للصفحة الشخصية (Profile) بعد التسجيل
        navigate('/profile');
    };
    ...
    return (
        <div className="min-h-screen bg-[#F5F0EB] relative overflow-hidden font-sans flex items-center justify-center py-12">
            ...
            <div className="relative z-10 w-full max-w-md mx-4">
                ...
                {/* Decorative Element */}
                <div className="absolute -z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-br from-[#D4B895]/20 to-transparent rounded-full blur-3xl pointer-events-none" />
            </div>
        </div>
    );
}